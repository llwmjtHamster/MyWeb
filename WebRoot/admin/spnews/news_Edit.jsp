...
<body>
<div class="x-body">
    <form id="form1" class="layui-form" action="<%=path%>/SPNewsServlet?action=editSave"
          method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="shipin" name="shipin" class="layui-input"  value="${news.shipin}" lay-verify="required">
