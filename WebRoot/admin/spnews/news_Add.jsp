...
<div class="x-body">
    <form id="form1" class="layui-form"
          action="<%=path%>/SPNewsServlet?action=add" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="imgpath" name="imgpath" class="layui-input" lay-verify="required">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="shipin" name="shipin" class="layui-input" lay-verify="required">
                <input type="button" value="选择视频" onclick="openDLG1()"/>
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <button class="layui-btn" lay-filter="tijiao" lay-submit="">提交</button>
            </div>
    </form>
</div>
...
<script>
    ...
    function openDLG1() {
        popWin.showWin("400", "150", "添加视频", "<%=path%>/common/shipinUpload.jsp");
