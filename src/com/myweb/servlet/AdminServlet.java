...
public class AdminServlet extends HttpServlet {
	...
	public void grxxsave() throws ServletException, IOException {
		...
		ServletBeanTools.populate(admin, _request);
		...
		admin.setLoginname(a.getLoginname());
		...
		_request.getRequestDispatcher("/admin/admin/grxx.jsp")
	...
	public void addAdmin() throws ServletException, IOException {
		...
		_request.getRequestDispatcher("/admin/admin/admin_Add.jsp").forward(_request,
				_response);
	...
	public void editAdmin() throws ServletException, IOException {
		...
		_request.getRequestDispatcher("/admin/admin/admin_Edit.jsp").forward(_request,
				_response);
	...
	public void listAdmin() throws ServletException, IOException {
		...
		_request.getRequestDispatcher("/admin/admin/admin_List.jsp").forward(_request,
				_response);
