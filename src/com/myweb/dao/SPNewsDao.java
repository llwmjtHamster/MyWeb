...
public class SPNewsDao {
    ...
    public List<Map<String, Object>> getNewsList() {
        ...
        db.getConnection();
        String sql2 = "select * from News  where newstype='1' order by id desc";
    ...
    public void delNewsByIds(String ids) {
        ...
        db.getConnection();
        String sql = "delete from News where newstype='1' and  id in (" + ids + ")";
    ...
    public News getNewsById(String id) {
        ...
        try {
            news = (News) db.findSimpleRefResult(sql, null, News.class);
    ...
    public Pager getPage(int pageNumber) {
        ...
        String sql = "select * from News where newstype='1' order by id ";
        ...
        if (pager.getPageNumber() > 0) {
            sql1 = "select * from News  where newstype='1'  order by id limit " + (pager.getPageNumber() - 1) * pager.getLimit() + "," + pager.getLimit();
        } else {
            sql1 = "select * from News   where newstype='1' order by id limit " + (pager.getPageNumber()) * pager.getLimit() + "," + pager.getLimit();
        }
